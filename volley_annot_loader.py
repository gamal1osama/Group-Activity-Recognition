...
def load_tracking_annot(path):
    with open(path, 'r') as file:
        ...
        for player_ID, boxes_info in player_boxes.items():
            ...
            boxes_info = boxes_info[6:] # i changed to 6 it was 5
            boxes_info = boxes_info[:-5] # i changed to -5 it was -6
...
def test_pkl_version():
    with open(f'{output_dir}/annot_all.pkl', 'rb') as file:
...
if __name__ == '__main__':
    ...
    clip_dir_path = f'{dataset_root}/volleyball_/videos/4/24745'
